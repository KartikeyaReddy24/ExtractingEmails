...
while True:
    ...
    with pd.ExcelWriter(str(timestamp)+".xlsx", engine='xlsxwriter') as writer:    
    ...
    for file in os.listdir():
        if file.endswith(str(timestamp)+".xlsx"):
            ...
            uploaded = upload_to_aws(os.path.dirname(os.path.realpath(__file__))+"/"+file,'extract.emails.storage',  "PreProductionTest/"+file)
