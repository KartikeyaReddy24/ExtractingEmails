...
while True:
    ...
    for cell in receipt:
        ...
        print("\n\t\t\t\tThis SQS message has been deleted.")
        time.sleep(10)
    ...
    with pd.ExcelWriter("Industries_"+str(MINIMUM)+"_"+str(count)+".xlsx", engine='xlsxwriter') as writer:    
    ...
    for file in os.listdir():
        if file.endswith("Industries_"+str(MINIMUM)+"_"+str(count)+".xlsx"):
            ...
            uploaded = upload_to_aws(os.path.dirname(os.path.realpath(__file__))+"/"+file,'extract.emails.storage',  "Trial_Output/"+file)
